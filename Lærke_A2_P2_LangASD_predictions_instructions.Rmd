...
crossValidation$m_diff <- abs(crossValidation$trainRMSE_m - crossValidation$testRMSE_m)

mean(crossValidation$basic_diff)
mean(crossValidation$m_diff)

mean(crossValidation$trainRMSE_basic)
mean(crossValidation$testRMSE_basic)
mean(crossValidation$trainRMSE_m)
mean(crossValidation$testRMSE_m)
```
...
# m1 <- lmer(CHI_MLU ~ Visit + I(Visit^2) + Diagnosis + Visit*Diagnosis + verbalIQ1 + (1 + Diagnosis + MOT_MLU | Child.ID), train)
# m2 <- lmer(CHI_MLU ~ Visit + I(Visit^2) + Diagnosis + Visit*Diagnosis + verbalIQ1 + (1 | Child.ID), train)
# m3 <- lmer(CHI_MLU ~ Visit + I(Visit^2) + Diagnosis + Visit*Diagnosis + verbalIQ1 + (1 +  MOT_MLU | Child.ID), train)
# m4 <- lmer(CHI_MLU ~ Visit + I(Visit^2) + Diagnosis + Visit*Diagnosis + verbalIQ1 + (1 + Diagnosis | Child.ID), train)
