...
#old name: "quadratic"
chi_mlu1 <- lmer(CHI_MLU ~ Visit + Visit2 + Diagnosis + Visit*Diagnosis + (1 + Diagnosis + MOT_MLU | Child.ID), na.action = na.exclude, new_df)

#old name: "model8"
chi_mlu2 <- lmer(CHI_MLU ~ Age * ADOS2 + ExpressiveLangRaw + (1 | Child.ID), na.action = na.exclude, new_df)

anova(chi_mlu1, chi_mlu2)
