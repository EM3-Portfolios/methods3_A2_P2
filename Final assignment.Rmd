...
```{r setting up data and columns, Cecilie}
...
```{r load models and view r.squared, Cecilie}
...
```{r evaluating performance of model using RMSE() function, Anne}
#- calculate performance of the model on the training data: root mean square error is a good measure. (Tip: google the function rmse())
...
crossValidation1Mean <- data.frame(models, mean_train, mean_test) # m3 wins
```
